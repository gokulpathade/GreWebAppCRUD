...
public class FinancialTarget2 {
	 ...
	 * @param year_id
	 */
	public FinancialTarget2(Long targetid2, String category, String location, Double apr, Double aug, Double december,
	...
	public String toString() {
		return "FinancialTarget2 [targetid2=" + targetid2 + ", category=" + category + ", location=" + location
